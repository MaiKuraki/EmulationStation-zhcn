	...
	mSavedCallback(saveCallback), mDeleteFunc(deleteFunc)
{
	...
	if(!scraperParams.system->hasPlatformId(PlatformIds::PLATFORM_IGNORE))
		buttons.push_back(std::make_shared<ButtonComponent>(mWindow, "爬虫", "scrape", std::bind(&GuiMetaDataEd::fetch, this)));
	...
	if(mDeleteFunc)
	{
		...
		auto deleteBtnFunc = [this, deleteFileAndSelf] { mWindow->pushGui(new GuiMsgBox(mWindow, "这将删除你的游戏文件！\n你确定吗？", "是", deleteFileAndSelf, "否", nullptr)); };
