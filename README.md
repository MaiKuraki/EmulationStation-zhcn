...
The command is multithreaded and won't slow down rendering. But weird command (slower than 1 sec, e.g: find) is still a bad choice since it will affect batterylife. A wise way is to use something like "cat xxx" to speed up.  
